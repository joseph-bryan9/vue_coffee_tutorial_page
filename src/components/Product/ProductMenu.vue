<template>
  <section class="page-section">
    <div class="container">
      <div class="product-item" v-for="(menu, index) in menus" :key="menu">
        <div class="product-item-title d-flex">
          <div
            class="bg-faded p-5 d-flex rounded"
            :class="[{ 'ml-auto': index === 2 }]"
          >
            <h2 class="section-heading mb-0">
              <span class="section-heading-upper">{{
                menu.sectionHeadingUpper
              }}</span>
              <span class="section-heading-lower">{{
                menu.sectionHeadingLower
              }}</span>
            </h2>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      menus: [
        {
          sectionHeadingUpper: "blended to perfection",
          sectionHeadingLower: "coffees & teas",
          photos: require("@/img/products-01.jpg"),
          description:
        ...
        {
          sectionHeadingUpper: "delicious treats, good eats",
          sectionHeadingLower: "bakery & kitchen",
          photos: require("@/img/products-02.jpg"),
          description:
        ...
        {
          sectionHeadingUpper: "from around the world",
          sectionHeadingLower: "bulk specialty blends",
          photos: require("@/img/products-03.jpg"),
          description:
